      ...
      >
        <SimpleGrid columns={{ base: 1, md: 4 }} spacing={12}>
          ...
          <Stack spacing={6}>
            <Box>
              ...
              <Text fontSize={"sm"} mt={2} color={"gray.400"}>
                Modern solar, backup power, and electrical solutions for homes
                and businesses in Mutare and surrounding areas.
              </Text>
            </Box>
            <Stack direction={"row"} spacing={4}>
              <SocialButton
                label={"Facebook"}
                onClick={(e) => handleNotice(e, "Our Facebook page")}
              >
                <FaFacebook />
              </SocialButton>
              <SocialButton
                label={"Twitter"}
                onClick={(e) => handleNotice(e, "Our Twitter profile")}
              >
                <FaTwitter />
              </SocialButton>
              <SocialButton
                label={"Instagram"}
                onClick={(e) => handleNotice(e, "Our Instagram profile")}
              >
                <FaInstagram />
              </SocialButton>
              <SocialButton
                label={"LinkedIn"}
                onClick={(e) => handleNotice(e, "Our LinkedIn profile")}
              >
                <FaLinkedin />
              </SocialButton>
            </Stack>
          ...
          <Stack align={"flex-start"} maxW="300px">
            ...
            <Text
              as="a"
              href="info@gmundietaelectrical.com"
              color={"gray.400"}
