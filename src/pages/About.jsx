      ...
      >
        ...
        <Container maxW={"container.lg"} position={"relative"} zIndex={1}>
          ...
          <Text
            ...
            mx="auto"
          >
            A boutique local team dedicated to powering Mutare's future through
            precision craftsmanship and sustainable energy solutions.
          </Text>
        </Container>
      </Box>
      ...
      <Container maxW={"container.xl"} py={20}>
          ...
          <Stack spacing={8}>
            <Box>
              ...
              <Text
                ...
                lineHeight="tall"
              >
                At G.MUNDIETA Electrical, we believe reliable power should be
                simple, safe, and sustainable. As a growing local business, our
                mission is to provide Mutare homeowners and businesses with
                clean energy transitions that are neat, compliant, and built to
                last.
              </Text>
              <Text
                fontSize={"lg"}
                ...
                lineHeight="tall"
              >
                We don't just install systems; we build relationships. Every
                project is handled with the personal care of a local team
                combined with the professional standards of industry experts.
              </Text>
            </Box>
        ...
        >
          ...
          <SimpleGrid columns={{ base: 1, sm: 2, md: 4 }} spacing={8}>
            <Stat icon={FaSolarPanel} label={"Installations"} value={"5+"} />
            <Stat icon={FaUsers} label={"Happy Clients"} value={"20+"} />
            <Stat icon={FaLeaf} label={"Clean Energy"} value={"15kW+"} />
